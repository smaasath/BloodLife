    ...
    <body>
            ...
            <div class="container bg-white m-0 p-0" style=" max-height: 373px; overflow: scroll;">
                <table class="table table-hover p-0">
                    ...
                    <tr>
                        ...
                        <td class="col-1"><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#openBloodbankDetails">View</button></td>
                        <td class="col-1"><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editBloodbankDetails">Edit</button></td>
                    </tr>

                    <tr>
                        <td class="col-1">BBID001</td>
                        <td class="col-3"> Regional Blood Centre</td>
                        <td class="col-2">Victoria Rd, Jaffna</td>
                        <td class="col-3">Jaffna</td>
                        <td class="col-3">Jaffna</td>
                        <td class="col-3">94212223063</td>
                    ...
                    <tr>
                        <td class="col-1">BBID001</td>
                        <td class="col-3"> Regional Blood Centrea</td>
                        <td class="col-2">Victoria Rd, Jaffna</td>
                        <td class="col-3">Jaffna</td>
                        <td class="col-3">Jaffna</td>
                        <td class="col-3">94212223063</td>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                 <p>--------------------------------------------------</p>
                  <form action="">
                    <label for="HosId">Blood bank ID &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</label>
                    <input type="text" id="BbId" name="HosId" required><br><br>
                    <label for="HosName">Blood Bank Name:</label>
                    <input type="text" id="BbName" name="HosName" required><br><br>
        ...
        <div class="modal fade" id="openBloodbankDetails" tabindex="-1" aria-labelledby="openBloodbankDetailsLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="openBloodbankDetailsLabel">Veiw Blood Bank Details</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal1" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                  ... 
