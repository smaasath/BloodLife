...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    Donor::AddDonor($name, $bloodGroup, $dob, $contactNumber, $nic, $noOfDonation, $coinValue, $donationLastDate, $availability, $medicalReport, 1, $districtId, $UserName, $password, $email);
}