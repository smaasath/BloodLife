        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function updateCountdown() {
                ...
                if (countdown === 0) {
                    ...
                    window.location.href = "Hospitalservices.php";
                } else {
                    countdown--;
...
<body>
    <div class="card">
        <form action="<?php echo $_GET["type"]=="hospital" ? "Hospitalservices.php" : ($_GET["type"]=="bloodbank" ? "bloodbankservices.php":"");?>" method="POST" >
