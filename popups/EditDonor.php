...
<div class="row align-items-center pb-3">
    ...
    <div class="col-9">
        <input class="form-control"  type="file" name="medicalReport" accept=".jpg">
        <p style="font-size: 9px; color: red;">Only jpg</p>
       <?php echo '<img src="data:image/jpeg;base64,' . base64_encode($Donor->getMedicalReport()) . '" style="width:30%">';?>
    </div>
</div>
...
<div class="row align-items-center pb-3">
    ...
    <div class="col-9">
        <input type="text" name="dob" value="<?php echo $Donor->getAvailability(); ?>"  class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" required>
    </div>
</div>
